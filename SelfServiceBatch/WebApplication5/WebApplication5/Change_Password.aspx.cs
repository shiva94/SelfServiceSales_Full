        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            if (dr.Read())
            {
                ...
                //{
                    ...
                    con1.Open();
                    string str = "update LoginPage set SecurityQuestion=@q,Answers=@a,Password='" + TextBox2.Text + "'where Password= '" + TextBox1.Text + "'and Customer_id=" + Session["User"].ToString();
                    SqlCommand cmd1 = new SqlCommand(str, con1);
                    cmd1.Parameters.AddWithValue("@q", DropDownList1.Text);
                    cmd1.Parameters.AddWithValue("@a", Answer.Text);
